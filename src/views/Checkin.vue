          ...
          <div class="card bg-light">
            <div class="card-body" v-if="user">
              ...
              <section class="form-group">
                ...
                <input required class="form-control" id="displayName" type="text" v-model="displayName" />
              </section>
              <div class="form-group text-right mb-0 d-flex justify-content-end">
                <button class="btn btn-primary mt-2" type="submit">Check in</button>
              </div>
            </div>
